...
- `src/content/site.ts` — name, banner, photo, email/LinkedIn/GitHub links, summary
- `src/content/projects.ts` — project cards (`image` may be a photo path or a YouTube URL)
- `src/content/articles.ts` — local article cards (`image` may also be a YouTube URL)
